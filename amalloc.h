...
void  afree     (void* ptr);
/* */
void* samalloc  (size_t size, short rank, const size_t* n);
void* sacalloc  (size_t size, short rank, const size_t* n);
void* sarealloc (void* ptr, size_t size, short rank, const size_t* n);
void* saview    (void* data, size_t size, short rank, const size_t* n); 
/* Description:
 ...
 *  'afree', 'asize', 'afullsize', 'adata', 'arank', 'ashape', and
 *  'aisknown'.  This works because an internal header containing the
 ...
 *
 *  The 'aview' function is similar to amalloc but only allocates the
 ...
 * 
 *  The 'arealloc' function changes the dimensions and/or the size of
 ...
 *  is still deallocated when 'arealloc' fails.
 *
...
/* Descriptions:
 *  The function 'aisknown' checks if 'ptr' is a 'known multi-dimensional
 ...
 *
 *  The function 'adata' * returns the start of the data. The result
 *  is undefined if 'ptr' is not a known multi-dimensional array.  The
 *  function 'acdata' does the same but a returns a const pointer, and
